"""Tests for websocket connection state."""
...
class DummyApiConnectionGraphql:
    """Minimal API connection stand-in for websocket construction."""
...
def test_callbacks_are_instance_scoped() -> None:
    """Ensure callbacks registered on one websocket do not leak to another."""
